...
def payments(request):
    if request.method=='POST':
        ...
        ##ssl
        store_id='shopp6170ef7af0242'
        API_key='shopp6170ef7af0242@ssl'
...
def order_complete(request):
    ...
    try:
        ...
        try:
            description=f"SHOPPING BD SECURITY TOKEN FOR {request.user.email} : Order Number={order_number},Transaction id={transID},Amount={amount},Payment System={card_type},Status=VALID"
